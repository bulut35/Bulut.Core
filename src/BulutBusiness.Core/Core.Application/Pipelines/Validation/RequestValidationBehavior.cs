...
using MediatR;
using ValidationException = BulutBusiness.Core.Core.CrossCuttingConcerns.Types.ValidationException;

namespace BulutBusiness.Core.Core.Application.Pipelines.Validation;
