...
using MediatR;
using ValidationException = BulutBusiness.Core.CrossCuttingConcerns.Types.ValidationException;

namespace BulutBusiness.Core.Application.Pipelines.Validation;
