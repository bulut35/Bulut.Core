using BulutBusiness.Core.CrossCuttingConcerns.Extensions;
using BulutBusiness.Core.CrossCuttingConcerns.HttpProblemDetails;
using BulutBusiness.Core.CrossCuttingConcerns.Types;
using Microsoft.AspNetCore.Http;

namespace BulutBusiness.Core.CrossCuttingConcerns.Handlers;
