using BulutBusiness.Core.CrossCuttingConcerns.Handlers;
using BulutBusiness.Core.CrossCuttingConcerns.Logging;
using Microsoft.AspNetCore.Http;
using System.Net.Mime;
using System.Text.Json;

namespace BulutBusiness.Core.CrossCuttingConcerns.Middleware;
