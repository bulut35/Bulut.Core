using BulutBusiness.Core.Core.ElasticSearch.Constants;
using BulutBusiness.Core.Core.ElasticSearch.Models;
using Elasticsearch.Net;
using Nest;
using Nest.JsonNetSerializer;
using Newtonsoft.Json;

namespace BulutBusiness.Core.Core.ElasticSearch;
